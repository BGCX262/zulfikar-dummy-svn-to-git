                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content-regular">
                                    ...
                                    <input type="button" class="form-submit" ONCLICK="window.location.href='<?=base_url()?>index.php/dokumenkualifikasi/process/5'" /><a href="<?=base_url()?>index.php/dokumenkualifikasi/submit/4" class="form-kembali" style="font-size: x-large">&nbsp;&nbsp;&nbsp;&nbsp;</a>
