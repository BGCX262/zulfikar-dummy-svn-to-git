                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <p><br>
                                     <span class="style1">Berikut adalah daftar invoice dari dealer yang telah melakukan pengiriman barang. Admin LPSE harus melakukan pemeriksaan kesesuaian invoice tersebut dengan penerimaan barang oleh Unit Kerja, jika sudah sesuai, anda dapat melakukan pengiriman invoice kepada direktorat keuangan. </span></p>
                                    <p><br>
                                       </br>
                                    </p>
                                    <center>
                                	<table width="911" border=1 cellspacing="4">
                                	<tr>
                                		<th width="40"><div align="center" class="style1">No. PO</div></th>
                                		<th width="97"><div align="center" class="style1">Nama Dealer</div></th>
                                		<th width="109"><div align="center" class="style1">Nama Ulp</div></th>
                                		<th width="101"><div align="center" class="style1">Nilai PO</div></th>
                                		<th width="98"><div align="center" class="style1">Tanggal Batas Pemenuhan</div></th>
                                		<th width="91"><div align="center" class="style1">Status PO</div></th>
                                		<th width="80"><div align="center" class="style1">Tgl. Terima PO</div></th>
                                		<th width="114"><div align="center" class="style1">Status Invoice</div></th>
                                		<th width="103"><div align="center"><span class="style1"></span></div></th>
                                	</tr>
                                	<?php 
                                	$no=1;
                                	...
                                	<tr>
                                		...
                                		<td><div align="center" class="style1">Rp 
                               		      <?=$invoice[$i]['total_harga']?> 
                           		        ,- </div></td>
                                		<td><div align="center" class="style1">
                                		  <?=$invoice[$i]['tgl_pemenuhan']?>
                              		  </div></td>
                                		<td><div align="center" class="style1">
                                		  <?=$invoice[$i]['status_dealer']?>
                              		  </div></td>
                                		<td><div align="center" class="style1">
                                		  <?=$invoice[$i]['tgl_terima_po']?>
                              		  </div></td>
                                		<td><div align="center" class="style1">
                                		  <?=$invoice[$i]['status_invoice']?>
                              		  </div></td>
                                		<td><div align="center" class="style1"><a href="<?php echo base_url()."index.php/admin/admin_invoice_detail?id_PO=".$invoice[$i]['id_PO'];?>">Lihat Detail Invoice</a></div></td>
                                	</tr>
                                	<?php 
                                	$no++;
                                	} 
