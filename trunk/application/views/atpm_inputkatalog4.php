...
<table border="0" width="100%" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<img src="<?php echo base_url()?>uploads/<?php echo $PIC?>"
			alt="gambarmobil" />
		<form
			action="<?php echo base_url();?>index.php/atpm/submit_katalogstandar/4"
			method="post" enctype="multipart/form-data" id="form1">
		<div align="center">
		<table width="359" id="exterior_table">
			<tr>
				<td colspan="2">
				<div align="justify">
				<h2>Eksterior Mobil</h2>
				</div>
				</td>
			</tr>
			<tr>
				...
				<td><label>
				<div align="justify">: <input type="text" name="ext[]" /></div>
				</label></td>
			</tr>
			<tr>
				<td>
		...
		<br />
		<br />
		<input type="button" onclick="addExteriorElement()"
			value="&nbsp;Tambah&nbsp;" /></div>
		<br />
		<br />
		<br />
