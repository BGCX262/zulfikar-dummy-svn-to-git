                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <h1 align="center">Data Perencanaan Anda Sebelumnya</h1>
									...
									<table border="1">
                                    <tr >
                                    <th align="center">No MP</td>
                                    <th align="center">Merek</td>
                                    <th align="center">Nilai HPS</td>
                                    <th align="center">Status</td>
                                    <th align="center"><span class="style1">Pesan
                                    </td>  
                                    </span>                                  </tr>
                                    <?php $i=0;
                                    while($i<count($ajuan)) {
									?>
                                    <tr>
                                    <td align="center" class="style1"><?php echo $ajuan[$i]['id_ajuan'];?></td>
                                	<td width="80" align="center" class="style1"><?php echo $ajuan[$i]['merek'];?></td>
                                    <td width="150" align="center" class="style1">Rp. <?php echo $ajuan[$i]['total_hps'];?></td>
                                    <td width="100" align="center" class="style1"><?php echo $ajuan[$i] ['status']?></td>
                                    <td width="350" align="center" class="style1"><?php echo $ajuan[$i] ['pesan']?></td>
                                    <?php if ($ajuan[$i]['status']=="revisi"){?>
                                    <form action="<?php echo base_url();?>index.php/common/ulp_formulir_edit" method="post">
                                    	<td><span class="style1">
                                   	    <input type="submit" value="Ubah" >
                                   	    </input>
                                    	  <input type="hidden" name="id_ajuan" value="<?php echo $ajuan[$i]['id_ajuan'];?>" >
                                    	  <input type="hidden" name="id_tipe" value="<?php echo $ajuan[$i]['id'];?>" >
                                    	  <input type="hidden" name="id_katalog" value="<?php echo $katalog[0]['id'];?>">
                                  	  </span></td>
                                    	<?php }else{};?>
                                    </form>
                                    </tr>
                                   <?php $i++; } ?>
                                    ...
                                    <form method="get" action="<?=base_url()."index.php/common/ulp_browse?awal=n"?>" id="form1" name="pencarian">
                                      <h1 align="center">-----------------------------------------------------------------------------------</h1>
									  
									  <h1 align="center">Lakukan Perencanaan Pengadaan Mobil</h1>
									  <b>Untuk melakukan perencanaan pengadaan mobil, silahkan ikuti tahapan di bawah ini. </b> <br><br><br>
	  								  <b>1. Browse Katalog Mobil</b> <br><br><br>
                                      <center>
                                      <table width="300">
                                      <tr>
                                      <td align="left"><input type="hidden" name="awal" value="n"></input>Merk</td>
                                      <td>:</td>
                                      <td>
                                      ...
                                      <td></td>
                                      <td>
                                      <form method="post" action="<?php echo base_url();?>index.php/common/ulp_rencana" name="hasilCari">
