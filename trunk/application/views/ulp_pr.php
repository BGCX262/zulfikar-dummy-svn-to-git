                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <center>
                                   	...
                                   	<?php $i=0; while($i<count($PR)){?>
                					<tr>
                					<td align="center"><?php echo $PR[$i]['id_PO'];?></td>
                					<td align="center"><?php echo $PR[$i]['tanggal'];?></td>
                					<td align="center"><?php echo $tipe_mobil[0]['merek'];?></td>
                					<td align="center"><?php echo $tipe_mobil[0]['jenis'];?></td>
                					<td align="center"><?php echo $PR[$i]['tgl_PR'];?></td>
                					<td align="center"><?php echo $PR[$i]['jumlah_penawaran'];?></td>
                					<td align="center"><?php echo $PR[$i]['dealer'];?></td>
                					<td align="center"><a href="<?php echo base_url()."index.php/ulp/ulp_penawaran_dealer?id_PO=".$PR[$i]['id_PO']."&NMA=".$NMA."&id_tipe=".$tipe_mobil[0]['id']."&id_katalog=".$id_katalog;?>">Lihat Penawaran</a>
                					</tr>
                					<?php $i++;}?>
                                   	</table>
