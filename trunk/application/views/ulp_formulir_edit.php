                                ...
                                <div id="table-content">
                                    ...
                                    <center>
                                     ...
                                     <br><br>
                                      ...
                                      <b>3. Isi Formulir </b> <br><br><br>
                                      <center>
                                      
                                      <p></p>
                                      <form action="<?php echo base_url()."index.php/common/ulp_hps_edit"?>" method="post" >
                                      <table>
                                      <tr>
                                      <td><?php echo $tp[0]['merek'];?>,
                                      <?php echo $tp[0]['jenis'];?>,
                                      <?php echo $tp[0]['model'];?>,
                                      <?php echo $kt[0]['tipe'];?>,
                                      <?php echo $kt[0]['transmisi'];?></td>
                                      </tr>
                                      <tr>
                                      	<td>Jumlah :</td>
                                      	<td><input type="text" name="jumlah" value="<?php echo $material_plan[0]['jumlah']?>"></td>
                                      </tr>
                                      <tr>
                                      	<td>Keperluan :</td>
                                      	<td><textarea name="keperluan"><?php echo $material_plan[0]['keperluan']?></textarea></td>
                                      </tr>
                                      <tr>
                                      	<td>Departemen terkait :</td>
                                      	<td><input type="text" name="departemen" value="<?php echo $material_plan[0]['departemen']?>"></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                      <td></td>
                                      <td><input type="submit" name="" value="Hitung HPS"/></td>
                                      <input type="hidden" name="id_ajuan" value="<?php echo $material_plan[0]['id_ajuan'];?>"></input>
                                      <input type="hidden" name="id_tipe" value="<?php echo $tp [0] ['id'];?>"></input>
                                       <input type="hidden" name="id_katalog" value="<?php echo $kt [0] ['id'];?>"></input>
