                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <h1 align="center">Penerimaan Pesanan </h1>
                                  <p align="center" class="style1">&nbsp;<br>
                                    <span class="style2"><em>Dengan ini saya menyatakan telah menerima pesanan tersebut dikirimkan pada alamat yang benar dengan waktu penerimaan :                                      </em><br>
                                    <br>
                                      </span>
                                    <form action="<?php echo base_url()."index.php/ulp/updateStatus";?>" method="post" class="style2">  
                                      <p>
                                        <input type="hidden" value="<?php echo $id_PO;?>" name="id_PO">
                                        </input>
                                        <?php
                                    $i=0;
                                    while($i<count($stok_akhir)){
                                    ?>
                                        <input type="hidden" value="<?php echo $stok_akhir[$i]['stok_akhir'];?>" name="stok_akhir[]">
                                        </input>
                                        <input type="hidden" value="<?php echo $stok_akhir[$i]['id_warna'];?>" name="id_warna[]">
                                        </input>
                                        <?php $i++; } ?>
                                    Tanggal: 
                                    <input type="text" name="tgl_terima_po"> 
                                    <em>(0000-00-00)</em> Tahun - Bulan - Tanggal </p>
                                      <p><br>
                                      <span class="style3">Pernyataan ini dibuat dengan sebenar-benarnya. </span></p>
                                      <p><br>
                                        <input type="submit" value="Update Status PO">
                                          </p>
                                    </form>
                                    <p>&nbsp;</p>
                                    <p>&nbsp; </p>
