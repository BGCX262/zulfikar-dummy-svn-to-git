                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <p align="center" class="style1">Untuk melakukan pembelian mobil yang sudah dianggarkan pada APBD Jawa Barat, silahkan ikuti langkah di bawah ini.</p>
                                    <p align="center" class="style1">--------------------------------------------------------------------------------------------------------------------------------------------</p>
                                    <p align="center" class="style1">&nbsp;</p>
                                    <p class="style3">1. Pemeriksaan nomor mata anggaran yang akan digunakan </p>
                                    <br></br>
                                    <form action="<?php echo base_url();?>index.php/ulp/ulp_keterangan" method="post">
                                    <center>
                                    <table border="0">
                                    <tr>
                                    	<td align="left" width="150px"><span class="style2">
                                    	Nomor Mata Anggaran 
                                    	</span></td>
                                    ...
                                    <tr>
                                    <td align="left" width="150px"><span class="style2">Tahun</span></td>
                                    <td width="10px"><span class="style2">:</span></td>
                                    <td><span class="style2">
