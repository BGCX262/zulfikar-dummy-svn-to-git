                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <h1>Surat Pemenuhan Dealer</h1>
                                    <p>&nbsp;</p>
                                    <p align="center" class="style1">Berikut adalah daftar surat pemenuhan pesanan yang dikirimkan oleh dealer sebagai tanggapan terhadap purchase order yang dikirimkan oleh unit kerja (ULP).</p>
                                    <p align="center"><span class="style1">Surat ini digunakan sebagai bentuk kontrol LPSE terhadap pemenuhan pesanan yang dilakukan oleh dealer.</span></p>
                                    <p align="center"><br>
                                    </p>
                                    <p align="center"></br>
                                    </p>
                                	...
                                	<tr>
                                		<th width="49"><div align="center" class="style1">No. PO</div></th>
                                		<th width="130"><div align="center" class="style1">Nama Dealer</div></th>
                                		<th width="118"><div align="center" class="style1">Nama Ulp</div></th>
                                		<th width="112"><div align="center" class="style1">Nilai PO</div></th>
                                		<th width="104"><div align="center" class="style1">Tanggal Batas Pemenuhan</div></th>
                                		<th width="100"><div align="center" class="style1">Status PO</div></th>
                                		<th width="91"><div align="center" class="style1">Tgl. Terima PO</div></th>
                                		<th width="247"><div align="center"><span class="style1"></span></div></th>
                                	</tr>
                                	<?php 
                                	$no=1;
                                	...
                                	<tr>
                                		...
                                		<td><div align="center" class="style1"><a href="<?php echo base_url()."index.php/admin/admin_lihat_surat?id_PO=".$PO[$i]['id_PO']?>">Lihat Detail Surat</a> | <a href="<?php echo base_url()."index.php/admin/admin_lihat_PO?id_PO=".$PO[$i]['id_PO']?>">Lihat Detail PO</a></div></td>
                                	</tr>
                                	<?php 
                                	$no++;
                                	} 
