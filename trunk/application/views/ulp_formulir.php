                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
								    ...
								    <span class="style1"><strong>3. Pengisian Formulir Rencana Pengadaan </strong></span><br>
										 <br>
                                      <center>
                                      
                                      <p></p>
                                      <table>
                                      <form action="<?php echo base_url()."index.php/common/ulp_hps"?>" method="post" >
                                      <tr>
                                      <td colspan="3" align="center" class="style1"> <p>Mobil Pilihan Anda :</p>
                                        <p> <?php echo $tp[0]['merek'];?> - <?php echo $tp[0]['jenis'];?> - <?php echo $tp[0]['model'];?> - <?php echo $kt[0]['tipe'];?> - <?php echo $kt[0]['transmisi'];?>
                                        </p>
                                        <p>&nbsp;</p></td>
                                      </tr>
                                      
                                      <tr>
                                      	<td width="165" class="style1">Jumlah</td>
                                      	<td width="5" class="style1">:</td>
                                      	<td width="190"><input name="jumlah" type="text" class="style1" size="27"></td>
                                      </tr>
                                      
                                      <tr>
                                      	<td width="165" class="style1">Keperluan</td>
                                      	<td width="5" class="style1">:</td>
                                      	<td class="style1">
                                      ...
                                      <tr>
                                      	<td width="165" class="style1">Departemen terkait</td>
                                      	<td width="5" class="style1">:</td>
                                      	<td><input name="departemen" type="text" class="style1" size="27"></td>
                                      </tr>
                                      
                                      <tr>
                                      	<td width="165" class="style1">Daerah Pengiriman</td>
                                      	<td width="5" class="style1">:</td>
                                      	<td><span class="style1">
                                      	  <select name="daerah">
                                      		...
                                      		?>
                                      	    <option value="<?php echo $daerah[$a]['id'];?>"><?php echo $daerah[$a]['daerah'];?></option>
                                      	    <?php 
													}
                                      		?>
                                   	    </select>
                                      ...
                                      <tr>
                                      <td colspan="3" align="right"><input name="" type="submit" class="style1" value="Hitung HPS"/></td>
                                      <input type="hidden" name="id_tipe" value="<?php echo $tp [0] ['id'];?>"><td width="10"></input>
                                       <input type="hidden" name="id_katalog" value="<?php echo $kt [0] ['id'];?>">
                                      </tr>
                                      </form>
                                      </table>
                                      </p>
