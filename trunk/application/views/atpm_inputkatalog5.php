...
<table border="0" width="100%" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<div id="table-content"><!-- -----------------------Content Start Here ---------------------------------->
		<h1 align="center">Input Katalog Standar Mobil</h1>
		<p align="center" class="style1"><br />
		Merek : <?php echo $tipe['merek']?> <br />
		Jenis : <?php echo $tipe['jenis']?><br />
		Model :<?php echo $tipe['model']?><br />
		</p>
		<br />
		<Br />
		...
		<table border="1">
			...
			for($i=0;$i<count($katalog);$i++){
				?>
			<tr>
				<td>&nbsp;<?= $katalog[$i]['tipe']?>&nbsp;</td>
				<td>&nbsp;<?= $katalog[$i]['transmisi']?>&nbsp;</td>
				<td>&nbsp;<?= $katalog[$i]['cc']?>&nbsp;</td>
				<td>&nbsp;<?= $katalog[$i]['OfTR']?>&nbsp;</td>
			</tr>
			<?php
			}
			?>
		...
		<form id="form2" method="post"
			action="<?php echo base_url()?>index.php/atpm/submit_katalogstandar/5">
		<div align="center"></div>
		<table width="421" border="0" align="center">
			<tr>
				<input type="hidden" name="id_tipe" value="<?php echo $tipe['id']?>" />
			</tr>
			<tr>
				<th width="246" scope="col">
				<div align="justify" class="style2">Tipe</div>
				</th>
				<th width="165" scope="col">
				<div align="left" class="style2">
				<div align="justify"><label> : <input type="text" name="tipe" /> </label>
				</div>
				</div>
				</th>
			</tr>
			<tr>
				<th scope="row">
				<div align="justify" class="style2">Transmisi</div>
				</th>
				<td>
				<div align="justify" class="style2"><label>: </label> <select
					name="transmisi">
					<option value="Automatic">Automatic</option>
					<option value="Manual">Manual</option>
					<option value="Automatic TRD">Automatic TRD</option>
				</select></div>
				</td>
			</tr>
			<tr>
				<th scope="row">
				<div align="justify" class="style2">Isi Silinder (cc)</div>
				</th>
				<td>
				<div align="justify" class="style2"><label>: <input type="text"
					name="cc" /> </label></div>
				</td>
			</tr>
			<tr>
				<th scope="row">
				<div align="justify" class="style2">Harga Off the Road Jakarta</div>
				</th>
				<td>
				<div align="justify" class="style2"><label>: <input type="text"
					name="OfTR" /> </label></div>
			...
			<tr>
				<th scope="row">
				<div align="justify"><span class="style2"><span class="style2"></span></span></div>
				</th>
				<td>
				<div align="justify" class="style2"><label>
				<div align="right"><input type="submit" name="Submit" value="Submit" />
				<a href="<?php echo base_url()?>index.php/atpm/selesaiinput">Selesai Input</a>
			  </form>
			</div>
				</label></div>
		</td>
