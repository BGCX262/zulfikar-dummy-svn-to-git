                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content-regular">
                                    ...
                                    <form method="post" action="<?php echo base_url()?>index.php/dokumenkualifikasi/edit_process/2">
                                        <h3>E. Presiden Direktur/Pimpinan Perusahaan</h3>
                                        <div id="labelformulir">Nama</div>                      <input class="inp-form" type="text" name="dir_nama" value="<?php echo $dir_nama?>"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Nomor Identitas (KTP)</div>     <input class="inp-form" type="text" name="dir_noktp" value="<?php echo $dir_noktp?>"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Nomor Telepon Seluler</div>     <input class="inp-form" type="text" name="dir_hp" value="<?php echo $dir_hp?>"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Email</div>                     <input class="inp-form" type="text" name="dir_email" value="<?php echo $dir_email?>"/><label id="divmerah">*</label><br />
                                        ...
                                        <div id="labelformulir">Nama</div>                      <input class="inp-form" type="text" value="<?php echo $cp_nama?>" name="cp_nama"/><br />
                                        <div id="labelformulir">Nomor Identitas (KTP)</div>     <input class="inp-form" type="text" value="<?php echo $cp_noktp?>" name="cp_noktp"/><br />
                                        <div id="labelformulir">Nomor Telepon Seluler</div>     <input class="inp-form" type="text" value="<?php echo $cp_hp?>" name="cp_hp"/><br />
                                        <div id="labelformulir">Email</div>                     <input class="inp-form" type="text" value="<?php echo $cp_email?>" name="cp_email"/><br />
                                        <div id="labelformulir">Dokumen KTP</div>               <input id="file_upload2" name="file_upload" type="file" /><br />
                                        <br /><br />

                                        <h3>G. Surat Penunjukkan</h3>
                                        <div id="labelformulir">Surat Penunjukkan sebagai dealer resmi</div><input class="inp-form" type="text" name="auth_atpm" value="<?php echo $auth_atpm?>"/><label id="divmerah">*</label><br />
