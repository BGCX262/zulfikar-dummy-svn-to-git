                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                	...
                                	<tr>
                                		...
                                		<th>Dealer</th>
                                		<th>Nilai PO</th>
                                		<th>Tanggal Batas Pemenuhan</th>
                                		<th></th>
                                	</tr>
                                	<?php 
                                	$no=1;
                                	for($i=0;$i<count($ulp_update1);$i++){?>
                                	<tr>
                                		<td><?=$no?></td>
                                		<td><?=$ulp_update1[$i]['tanggal']?></td>
                                		<td><?=$ulp_update1[$i]['status_dealer']?></td>
                                		<td><?=$ulp_update1[$i]['dealer']?></td>
                                		<td><?=$ulp_update1[$i]['total_harga']?></td>
                                		<td><?=$ulp_update1[$i]['tgl_pemenuhan']?></td>
                                		<td><a href="#">Update Status PO</a></td>
                                	</tr>
                                	<?php 
                                	$no++;
                                	} 
