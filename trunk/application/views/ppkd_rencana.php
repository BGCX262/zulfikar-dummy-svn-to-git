                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <p align="center" class="style2 style1">Berikut adalah daftar rencana pengadaan yang masuk dan perlu diperiksa.</p> <br><br />
                                    <form action="<?php echo base_url();?>index.php/common/ppkd_rencana_det" method="post" enctype="multipart/form-data" id="form1">
                                      <center>
                                      <table border="1" width="1000">
                                      <tr>
                                      <td><div align="center" class="style1">
                                        <div align="center">No. MP</div>
                                      </div></td>
                                      <td><div align="center" class="style1">
                                        <div align="center">Tipe mobil</div>
                                      </div></td>
                                      <td><div align="center" class="style1">
                                        <div align="center">Nilai HPS</div>
                                      </div></td>
                                      <td><div align="center" class="style1">Status</div></td>
                                      <td><div align="center" class="style1">Pesan</div></td>
                                      </tr>
                                      <?php $a=0;
                                      while ($a<count($ar)){
                                      ?>
                                      <tr>
                                      <td><div align="center" class="style1"><?php echo $ar[$a]['id_ajuan'];?></div></td>
                                      <td><div align="center" class="style1">
                                        <div align="center"><?php echo $ar[$a]['merek'];?></div>
                                      </div></td>
                                      <td><div align="center" class="style1">
                                        <div align="center"><?php echo $ar[$a]['total_hps'];?></div>
                                      </div></td>
                                      <td><div align="center" class="style1">
                                        <div align="center"><?php echo $ar[$a]['status'];?></div>
                                      </div></td>
                                      <td width="300"><div align="center" class="style1"><?php echo $ar[$a]['pesan'];?></div></td>
                                      <form action="<?php echo base_url();?>index.php/common/ppkd_rencana_det" method="post">
                                      <td><input type="submit" value="Detail">
                                       <input type="hidden" name="id_ajuan" value="<?php echo $ar[$a]['id_ajuan'];?>">
                                        <input type="hidden" name="status" value="<?php echo $ar[$a]['status'];?>">
                                     </td>
                                      </form>
                                      </tr>
                                      <?php 
