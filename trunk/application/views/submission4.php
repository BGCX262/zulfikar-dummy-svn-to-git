                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content-regular">
                                    ...
                                    <form method="post" action="<?php echo base_url()?>index.php/dokumenkualifikasi/process/4">
                                        <h3>M. Nomor Pokok Wajib Pajak (NPWP)</h3>
                                        <div id="labelformulir">Nomor NPWP</div>                    <input class="inp-form" type="text" name="npwp_no"/>       <br />
                                        ...
                                        <div id="labelformulir">Nomor PKP</div>                  <input class="inp-form" type="text" name="pkp_no"/>       <br />
                                        <div id="labelformulir">Tanggal Terdaftar   </div>
                                        ...
                                        <div id="labelformulir">Nomor Bukti Surat Setoran Pajak</div><input class="inp-form" type="text" name="spt_nosetoran"/> <br />
                                        ...
                                        <div id="labelformulir">Nama Paket 1</div>                  <input class="inp-form" type="text" name="exp_nama1"/><br />
                                        <div id="labelformulir">Pemilik Proyek 1</div>              <input class="inp-form" type="text" name="exp_own1"/><br />
                                        <div id="labelformulir">Nilai Paket 1</div>                 <input class="inp-form" type="text" name="exp_value1"/><br />
                                        ...
                                        <div id="labelformulir">Nama Paket 2</div>                  <input class="inp-form" type="text" name="exp_nama2"/><br />
                                        <div id="labelformulir">Pemilik Proyek 2</div>              <input class="inp-form" type="text" name="exp_own2"/><br />
                                        <div id="labelformulir">Nilai Paket 2</div>                 <input class="inp-form" type="text" name="exp_value2"/><br />
                                        ...
                                        <div id="labelformulir">Nama Paket 3</div>                  <input class="inp-form" type="text" name="exp_nama3"/><br />
                                        <div id="labelformulir">Pemilik Proyek 3</div>              <input class="inp-form" type="text" name="exp_own3"/><br />
                                        <div id="labelformulir">Nilai Paket 3</div>                 <input class="inp-form" type="text" name="exp_value3"/><br />
                                        ...
                                        <div id="labelformulir">Nama Paket 4</div>                  <input class="inp-form" type="text" name="exp_nama4"/><br />
                                        <div id="labelformulir">Pemilik Proyek 4</div>              <input class="inp-form" type="text" name="exp_own4"/><br />
                                        <div id="labelformulir">Nilai Paket 4</div>                 <input class="inp-form" type="text" name="exp_value4"/><br />
                                        ...
                                        <div id="labelformulir">Nama Paket 5</div>                  <input class="inp-form" type="text" name="exp_nama5"/><br />
                                        <div id="labelformulir">Pemilik Proyek 5</div>              <input class="inp-form" type="text" name="exp_own5"/><br />
                                        <div id="labelformulir">Nilai Paket 5</div>                 <input class="inp-form" type="text" name="exp_value5"/><br />
                                        ...
                                        <a href="<?=base_url()?>index.php/dokumenkualifikasi/submit/3" class="form-kembali" style="font-size: x-large">&nbsp;&nbsp;&nbsp;&nbsp;</a>&nbsp;<input type="submit" class="form-lanjut"/>
                                    </form>
