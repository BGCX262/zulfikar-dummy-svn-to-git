...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <img src="<?php echo base_url()?>images/shared/logo.png" alt="lambang jawa barat"/>
                                    <br /><br /><br />
                                    <?php
                                    $pesan=$this->session->userdata('system_message');
                                    if(strlen($pesan)!=0) {
                                        echo "<div><h2>$pesan</h2></div>";
                                        $this->session->unset_userdata('system_message');
                                    }else {
                                        echo "<div><h2>Sistem E-purchasing mobil Pemerintah Daerah Jawa Barat</h2></div>";
                                    }?>
        ...
        <div id="footer">
            ...
            <!--  start footer-left -->
            <div id="footer-left">
                Sistem ini masih merupakan purwarupa dan dikembangkan untuk
                kepentingan akademis. Penggunaan untuk lingkungan sebenarnya
                terutama yang berhubungan dengan aspek keamanan dan enkripsi
