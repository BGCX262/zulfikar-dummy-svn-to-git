                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                 <form action="<?php echo base_url();?>index.php/dealer/dealer_invoice_detail" method="get" name="po" >
                                <center>
                                <table border="1" >
                                <tr>
                                <th width="150px" align="center">NO</th>
                                <th width="150px" align="center">Tanggal</th>
                                <th width="150px" align="center">Batas Pemenuhan</th>
                                <th width="150px" align="center">Dealer</th>
                                <th width="150px" align="center">Merek</th>
                                <th width="150px" align="center">Nilai PO</th>
                                <th width="150px" align="center">Status Invoice</th>
                                </tr>
                                ...
                                <td><a href="<?php echo base_url()."index.php/dealer/dealer_invoice_detail1?id_PO=".$purchaseOrder[$a]['id_PO'];""?>"><?php echo $purchaseOrder[$a]['id_PO']; ?></a>
                              	<input type="hidden" name="id_PO" value="<?php echo $purchaseOrder[$a]['id_PO']; ?>"></td>
                                <td align="center"><?php echo $purchaseOrder[$a]['tanggal'];?></td>
                               <td align="center"><?php echo $purchaseOrder[$a]['tgl_pemenuhan'];?></td>
                                <td align="center"><?php echo $purchaseOrder[$a]['dealer'];?> </td>
                                <td align="center"><?php echo $tipe[$a]['merek'];?></td>
                                <td align="center"><?php echo $purchaseOrder[$a]['total_harga'];?></td>
                                <td align="center"><?php echo $purchaseOrder[$a]['status_invoice'];?></td>
                                </tr>
                                <?php $a++;
                                }
                                ?>
