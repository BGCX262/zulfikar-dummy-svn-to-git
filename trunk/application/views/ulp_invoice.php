                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                   ...
                                   <!--  <form action="" method="post" enctype="multipart/form-data" id="form1">-->
                                    	 <form action="<?php echo base_url();?>index.php/common/ulp_invoice_detail" method="get" name="po" >
                                <center>
                                ...
                                <td align="center">Batas Pemenuhan</td>
                                <td align="center">Dealer</td>
                                <td align="center">Merek</td>
                                <td align="center">Nilai PO</td>
                                </tr>
                                ...
                                <td><a href="<?php echo base_url()."index.php/common/ulp_invoice_detail?id_PO=".$purchaseOrder[$a]['id_PO'];""?>"><?php echo $purchaseOrder[$a]['id_PO']; ?></a>
                              	<input type="hidden" name="id_PO" value="<?php echo $purchaseOrder[$a]['id_PO']; ?>"></td>
                                <td><?php echo $purchaseOrder[$a]['tanggal'];?></td>
                                <td><?php echo $purchaseOrder[$a]['status_dealer'];?></td>
                                <td><?php echo $purchaseOrder[$a]['tgl_pemenuhan'];?></td>
                                <td><?php echo $purchaseOrder[$a]['dealer'];?> </td>
                                <td><?php echo $tipe[$a]['merek'];?></td>
                                <td><?php echo $purchaseOrder[$a]['total_harga'];?></td>
                                </tr>
                                <?php $a++;
                                }
                                ?>
