                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <tr height="20px"></tr>
                                <tr>
                                <td align="left" colspan="2"><span class="style1">dengan detail pesanan sebagai berikut :</span></td>
                         		</tr>
                         		 <tr height="20px"></tr>
                                <tr>
                                ...
                                <td>
                                		...
                                		<tr>
                                		<td class="style2">Warna</td>
                                		<td><span class="style1"><strong>Stok</strong></span></td>
                                		<td><span class="style1"><strong>Pesan</strong></span></td>
                                		</tr>
                                		<?php $a=0;
                                		while($a<count($warna)){
                                		...
                                		<td><span class="style1"><?php echo $stok [$a]['stok'];?></span></td>
                                		<td><span class="style1"><?php echo $pesanan[$a]['jumlah_pesan'];?></span></td>
                                		</tr>
                                		...
                                		<td><span class="style1"><?php echo $purchaseOrder[0]['jumlah_pesanan'];?></span></td>
                                		</tr>
                           		  </table>
                           		  <p>&nbsp;</p></td>
                                </tr>
                               <tr>
                            	...
                            	<p align="left" class="style1">Pesanan tersebut akan dipenuhi (diterima oleh pemesan) selambat-lambatnya tanggal :</p>                           		</td>
                                 ...
                                 <tr>
                                <td colspan="2" align="center">
                                <p class="style2"><?php echo $purchaseOrder[0]['tgl_pemenuhan']; ?></p>                           		</td>
                                </tr>
                                <tr>
                                 <tr height="20px"></tr>
                                <td colspan="2" align="left">
                            	<p class="style2">&nbsp;</p>
                            	<p class="style2">Surat ini dibuat dengan sebenar-benarnya dan jika tidak terpenuhi , kami siap dikenakan sanksi oleh LPSE.</p></td>
                                </tr>
                                 <tr height="10px"></tr>
                                <tr>
