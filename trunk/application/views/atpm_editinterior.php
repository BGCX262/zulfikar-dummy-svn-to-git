                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <h1 align="center">Edit Interior </h1>
                                    <p align="center" class="style1">Merek : <span class="style2"> <?=$merek['merek']?> </span></p>
                                    <center>
                                    <form method="POST" action="<?php echo base_url()."index.php/common/editInterior"?>" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?=$tipe[0]['id']?>">
                                    <input type="hidden" name="int_prev" value="<?=$int?>">
                                    <input type="hidden" name="int_doc_prev" value"<?=$int_doc?>">
                                    <input type="hidden" name="int_desc_prev" value="<?=$int_desc?>">
                                    <table>&nbsp;
                                    
                                    <tr>
                                    	<th>Gambar:</th>
                                    	<td><img src="<?php echo base_url();?>uploads/<?=$int_doc?>" width="150" height="150"><br>
										<input type="file" name="userfile"/></td>
                                    </tr>
                                    <tr>
                                    	<th>Nama Interior:</th>
                                    	<td><input type="text" size="25" name="int" value="<?=$int?>"></td>
                                    </tr>
                                    <tr>
                                    	<th>Deskripsi:</th>
                                    	<td><input type="text" size="25" name="int_desc" value="<?=$int_desc?>"></td>
                                    </tr>
                                    <tr>
                                    	<td></td>
