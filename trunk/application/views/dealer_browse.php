    ...
    <body>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <!--  start page-heading -->
                <div id="page-heading">
                    <center><h1>Input Harga Katalog Mobil</h1></center>
                </div>
                <!-- end page-heading -->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <center>
                                <div align="center">
                                  <p><span class="style1">Nama ATPM: <?php echo $tes[0]['atpm_name'];?> </span></p>
                                  <p><span class="style1">Merek: <?php echo $tes[0]['merek'];?>                                </span><br>
                                    <br>
                                    </p>
                                </div>
                            <table border=1 align="center">
                                    	<tr>
                                    		<th width=108><span class="style1">Jenis Mobil</span></th>
                                    		<th width=88><span class="style1">Model</span></th>
                                    		<th width=92><span class="style1">Transmisi</span></th>
                                    		<th width=151><span class="style1">Tipe</span></th>
                                    		<th width=55><span class="style1">CC</span></th>
                                    		<th width="164"></th>
                               	</tr>
                                    	
                                    	<?php 
                                    	for($r=0; $r<count($katalog); $r++){ ?>
                                    		<?php
                                    		for($i=0; $i<count($tes); $i++){
                                    		if($tes[$i]['id'] == $katalog[$r]['id_tipe']){
                                    		?>
                                    	<tr>
                                    	<td><div align="center" class="style2"><?php echo $tes [$i] ['jenis'];?></div></td>
                                    	<td><div align="center" class="style2"><?php echo $tes [$i] ['model'];?> </div></td>
                                    	<td><div align="center" class="style2"><?php echo $katalog [$r] ['transmisi'];?></div></td>
                                    	<td><div align="center" class="style2"><?php echo $katalog [$r] ['tipe'];?></div></td>
                                    	<td><div align="center" class="style2"><?php echo $katalog [$r] ['cc'];?></div></td>
                                    	<td><div align="center" class="style2"><a href="<?php echo base_url()."index.php/dealer/tampilharga?id_katalog=". $katalog[$r]['id'] ?>">Input Harga</a>
                                    		| <a href="<?php echo base_url()."index.php/common/input_stok/".$katalog[$r]['id'] ?>">Input Stok</a></div></td>
                                    	</tr>
                                    	<?php 
                                    			break;
                                   				}
