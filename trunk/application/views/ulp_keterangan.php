                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <p class="style2"><strong>2. Keterangan nomor mata anggaran</strong></p>
                                    <br></br>
                                    <form action="<?php echo base_url()."index.php/ulp/ulp_browse3"?>" method="get">
                                    <center>
                                    <table border="0">
                                    <tr>
                                    	<td align="left"><p class="style2">
                                    	Nomor mata anggaran yang Anda masukan 
                                    	</p>
                                   	    <p class="style2">&nbsp;</p></td>
                                    	<?php 
                                    	$keterangan1=count($keterangan);
										  if ($keterangan1>0){
										  	if($keterangan[0]['status_ang']==0){                              
                                    ?>
                                    	<td width="10px"><p class="style2">:</p>
                                   	    <p class="style2">&nbsp;</p></td>
                                    	<td><h2 class="style2">BENAR</h2>
                                   	    <p class="style2">&nbsp;</p></td>
                                    </tr>
                                    <tr>
                                    <td align="left"><p class="style2">Anda dapat melakukan pembelian mobil dengan detail sebagai berikut</p>
                                      <p class="style2">&nbsp;</p></td>
                                    <td width="10px"><p class="style2">:</p>
                                      <p class="style2">&nbsp;</p></td>   
                                    </tr>
                                    <tr>
                                    <td align="left"><span class="style2">Tahun Anggaran</span></td>
                                    <td width="10px"><span class="style2">:</span></td>
                                    <td><span class="style2"><?php echo $keterangan[0]['tahun'];?></span></td>
                                    </tr>
                                      <tr>
                                    <td align="left"><span class="style2">Nomor Mata Anggaran</span></td>
                                    <td width="10px"><span class="style2">:</span></td>
                                    <td><span class="style2"><?php echo $keterangan[0]['nomor_ang'];?></span></td>
                                    </tr>
                                     <tr>
                                    <td align="left"><span class="style2">Nilai Anggaran</span></td>
                                    <td width="10px"><span class="style2">:</span></td>
                                    <td><span class="style2">Rp <?php echo $keterangan[0]['nilai_ang'];?> ,- </span></td>
                                    </tr>
                                     <tr>
                                    <td align="left"><span class="style2">Daerah Terkait</span></td>
                                    <td width="10px"><span class="style2">:</span></td>
                                    <td><span class="style2"><?php echo $keterangan[0]['daerah'];?></span></td>
                                    </tr>
                                    <tr>
                                    <td colspan="3" align="right"><span class="style2">
                                    <input type="submit" name="submit" value="Lanjut">
                                    </input>
                                    </span></td>
                                    <input type="hidden" name="NMA" value="<?php echo $keterangan[0]['nomor_ang'];?>"></input>
                                    <input type="hidden" name="awal" value="y"></input>
                                    </tr>
                                    </table>
                                    </center>
                                   </form>
                                   ...
                                   <table>
                                   <tr>
                                    	<td align="center"><h2><font color="red">Telah Digunakan</font></h2></td>
                                    </tr>
                                    <tr>
                                    <td align="center" colspan="3">Anda tidak dapat melakukan pembelian mobil. </td>   
                                    </tr>
                                    <tr>
                                    <td align="center" colspan="3">Silahkan masukan kembali Nomor Mata Anggaran Anda <a href="<?php echo base_url();?>index.php/common/ulp_pembelian">Klik Disini</a></td>   
                                    </tr>
                                    </table>
                                  </center>
                                    <?php } }else{?>
                                   ...
                                   <table>
                                   <tr>
                                    	<td align="center"><h2><font color="red">Salah</font></h2></td>
                                    </tr>
                                    <tr>
                                    <td align="center" colspan="3">Anda tidak dapat melakukan pembelian mobil. </td>   
                                    </tr>
