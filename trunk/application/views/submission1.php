                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content-regular">
                                    ...
                                    <form method="post" action="<?php echo base_url();?>index.php/dokumenkualifikasi/process/1">
                                        <h3>A. Profil Perusahaan</h3>
                                        <div id="labelformulir">Nama Dealer</div><input type="text" name="nama" class="inp-form"/><label id="divmerah">*</label><br />
                                        ...
                                        <div id="labelformulir">Situs Perusahaan</div><input name="website" type="text" class="inp-form" /><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Merek yang Disediakan</div><input name="merekmobil" class="inp-form" type="text" /><label id="divmerah">*</label><br />
                                        <br /><br/>

                                        <h3>B. Rekening Perusahaan</h3>
                                        <div id="labelformulir">Nama Bank / Cabang</div><input name="bank" class="inp-form" type="text"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Nomor Rekening</div><input name="acc_number" class="inp-form" type="text"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Atas Nama</div><input name="acc_name" class="inp-form" type="text" /><label id="divmerah">*</label><br />
                                        <br /><br />

                                        <h3>C. Kantor Utama</h3>
                                        <div id="labelformulir">Alamat</div><input class="inp-form" type="text" name="of_addres"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Kode Pos</div><input class="inp-form" type="text" name="of_poskode"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Kota</div><input class="inp-form" type="text" name="of_city"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Provinsi</div><input class="inp-form" type="text" name="of_prov"/><br />
                                        <div id="labelformulir">No. Telepon</div><input class="inp-form" type="text" name="of_phone"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">No. Fax</div><input class="inp-form" type="text" name="of_fax"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">No. Telepon Alternatif</div><input class="inp-form" type="text" name="of_phone2"/><br />
                                        <div id="labelformulir">No. Fax Alternatif</div><input class="inp-form" type="text" name="of_fax2"/><br />
                                        <br /><br />

                                        <h3>D. Kantor Cabang</h3>
                                        <div id="labelformulir">Alamat      </div><input class="inp-form" type="text" name="of2_addres"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Kode Pos    </div><input class="inp-form" type="text" name="of2_poskode"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Kota        </div><input class="inp-form" type="text" name="of2_city"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">Provinsi    </div><input class="inp-form" type="text" name="of2_prov"/><br />
                                        <div id="labelformulir">No. Telepon </div><input class="inp-form" type="text" name="of2_phone"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">No. Fax     </div><input class="inp-form" type="text" name="of2_phone2"/><label id="divmerah">*</label><br />
                                        <div id="labelformulir">No. Telepon Alternatif</div><input class="inp-form" type="text" name="of2_fax"/><br />
                                        <div id="labelformulir">No. Fax Alternatif</div><input class="inp-form" type="text" name="of2_fax2"/><br /><br /><br />
