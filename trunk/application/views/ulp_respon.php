                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <form action="" method="post" id="form1"><br><br><br>
                                      <span class="style4"><br>
                                      </span>
                                      <p class="style4">Terimakasih.</p>
                                      <p class="style4"> Anda telah berhasil melakukan pengajuan rencana pengadaan mobil.</p>
                                      <p class="style4">Ajuan Anda akan segera diproses kebagian yang berwenang </p>
                                  </form>
                                    <p>&nbsp;</p>
                                    <p>&nbsp; </p>
