    ...
    <body>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <!--  start page-heading -->
                <div id="page-heading">
                    <center><h1>Evaluasi Dealer</h1></center>
                </div>
                <!-- end page-heading -->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <option value=0" selected="selected">-Pilih Nama Dealer-</option>
                                <?php
                                $total = 0;
                                 for($i=0; $i<count($dealer); $i++){
                                 ?>
                                     <option value="<?php echo base_url()."index.php/common/atpm_evaldealer/".$dealer[$i]['username'];?>"><?=$dealer[$i]['nama']?></option>
                                  <?php
                                  }
                                  ?></select>
                                  <br></br>
                                  Nama Dealer : <b><?=$username?></b>
                                  <center>
                                  <br><br>
                                  <table border="1">
                                  <tr>
                                  ...
                                  <tr>
                                  	...
                                  	if($eval == null){
                                  		...
                                  		for($a=0; $a<count($eval); $a++){
                                  			if($lalai[$i]['id'] == $eval[$a]['id_lalai']){
                                  				echo $lalai[$i]['poin'];
                                  				$total += $lalai[$i]['poin'];
                                  				break;
                                  			}else{
