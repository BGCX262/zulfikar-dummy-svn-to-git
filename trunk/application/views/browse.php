        ...
        <div class="nav-outer-repeat">
            ...
            <div class="nav-outer">
                ...
                <div id="nav-right">
                    ...
                    <div class="nav-divider"> <a href="<?php echo base_url();?>">Login</a></div>
                    <div class="clear">&nbsp;</div>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <form method="get" action="<?=base_url()."index.php/login/browse_katalog?awal=n"?>" id="form1" name="pencarian">
                                      <b>Browse Katalog Mobil</b> <br><br><br>
                                      <center>
                                      <table width="300">
                                      <tr>
                                      ...
                                      <td></td>
                                      <td>
                                      <form method="post" action="<?php echo base_url();?>index.php/login/hasilcari" name="hasilCari">
