                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <h1 align="center">Edit Katalog Mobil </h1>
                                    <p align="center" class="style1">Merek : <span class="style2"> <?=$merek['merek']?> </span></p>
                                    <center>
                                    <form method="POST" action="<?php echo base_url()."index.php/common/editKatalog"?>" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?=$katalog[0]['id']?>">
                                    <input type="hidden" name="id_tipe" value="<?=$katalog[0]['id_tipe']?>">
                                    <table>&nbsp;
									<tr>
                                    	<th>Jenis:</th>
                                    	<td><input type="text" size="25" name="jenis" value="<?=$tipe[0]['jenis']?>"></td>
                                    </tr>
                                    <tr>
                                    	<th>Model:</th>
                                    	<td><input type="text" size="25" name="model" value="<?=$tipe[0]['model']?>"></td>
                                    </tr>
                                    <tr>
                                    	<th>Tipe Mobil: </th>
                                    	<td><input type="text" size="25" name="tipe" value="<?=$katalog[0]['tipe']?>"></td>
                                    </tr>
                                    <tr>
                                    	<th>Transmisi :</th>
                                    	<td><input type="text" size="25" name="transmisi" value="<?=$katalog[0]['transmisi']?>"></td>
                                    </tr>
                                    <tr>
                                    	<th>Isi Silinder:</th>
                                    	<td><input type="text" size="25" name="cc" value="<?=$katalog[0]['cc']?>"></td>
                                    </tr>
                                    <tr>
                                    	<th>Harga off the road jakarta :</th>
                                    	<td><input type="text" size="25" name="OfTR" value="<?=$katalog[0]['OfTR']?>"></td>
                                    </tr>
                                    <tr>
									   	<th>Spek:</th>
                                    	<td><img src="<?php echo base_url();?>uploads/<?=$tipe[0]['spec']?>" width="200" height="100"><br>
                                    	<input type="file" size="25" name="userfile"></td>
                                    </tr>
                                    <tr>
                                    	<td></td>
