                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <center>
                                <h2 class="style1">Formulir Penawaran</h2>
                                ...
                                <table>
								<tr>
									<td width="272" class="style1">Tanggal Penawaran</td>
								  <td width="301" class="style1">: <input type="text" name="tgl_penawaran"> <em>(yyyy-mm-dd)</em>								</tr>
								<tr>
									<td class="style1">Harga Satuan On the Road Penawaran</td>
									<td class="style1">: <input type="text" name="ontr"></td>									
								</tr>
								<tr>
									<td class="style1">Pesan Penawaran</td>
									<td class="style1">: <textarea name="pesan"></textarea></td>
								</tr>
								</table>
								...
								*warna adalah spesifikasi opsional, jika anda tidak dapat memenuhi warna tersebut, silakan tuliskan warna yang dapat anda penuhi pada kolom pesan penawaan								</span><br>
								...
								<h2 class="style1">Detail Purchase Request</h2>  <br> </br>
								<span class="style1"><b>Tanggal PR : </b>
								...
								<tr>
									<td class="style1">Nilai Mata Anggaran</td>
									<td class="style1">: Rp <?=$anggaran[0]['nilai_ang']?> ,-</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="style1"></td>
									<td class="style1"><input type="button" value="Kembali" onclick="history.back()"> <input type="submit" value="Ajukan Penawaran"></td>
									<input type="hidden" name="jumlah_penawaran" value="<?=$purchaseOrder[0]['jumlah_penawaran']=$purchaseOrder[0]['jumlah_penawaran']+1?>">
								</tr>
								</table>
								</form>
								</center>
