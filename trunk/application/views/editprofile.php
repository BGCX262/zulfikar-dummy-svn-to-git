                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <form method="post" action="<?php echo base_url()."index.php/common/submitperubahan"?>">
                                    	<div>Nama Dealer :</div><input type="text" class="inp-form"  name="nama" value="<?php echo $nama;?>"> <br /><br />
                                    	<div>Waktu Berdiri :</div><input type="text" class="inp-form" value="<?php echo $time_formed;?>" name="time_formed"><br /><br />
                                    	<div>Situs Perusahaan :</div><input type="text" class="inp-form" value="<?php echo $website;?>" name="website"><br /><br />
                                    	<div>Merek yang disediakan :</div><input type="text" class="inp-form" value="<?php echo $merekmobil;?>" name="merekmobil"><br /><br />
                                    	<div>Status :</div><span style="color: red;font-weight: bold"><?php echo $text_status?></span><br /><br />
                                    	<div>Catatan dari Evaluator :</div><span style="color: red;font-weight: bold"><?php echo $komentar?></span><br /><br />
                                    	<input type="submit" value="&nbsp;&nbsp;Simpan Perubahan Profil&nbsp;&nbsp;" />
                                    </form>
                                </div>
                                <!--  end table-content  -->
