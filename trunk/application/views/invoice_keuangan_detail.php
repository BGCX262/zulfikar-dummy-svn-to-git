                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <form action="<?php echo base_url();?>index.php/keuangan/invoice_keuangan" method="post">
                                 
                                <table border="0" width="550">
                                <tr>
                                <td width="272"><h2 class="style1"><?php echo $dealer[0]['username'];?></h2></td>
                                </tr>
                                <tr>
                                ...
                                <td align="left"><span class="style3">: <?php echo $dealer[0]['bank'];?> / <?php echo $dealer[0]['acc_number'];?></span></td>
                                </tr>
                                <tr>
                                <td></td>
