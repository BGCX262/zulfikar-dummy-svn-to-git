                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <form action="<?php echo base_url();?>index.php/dealer/dealer_invoice" method="post">
                                
                                <table border="0" width="500">
                                <tr>
                                <td width="207"><h2><b><?php echo $purchaseOrder[0]['dealer'];?></b></h2></td>
                                </tr>
                                <tr>
                                <td align="left">No Invoice : </td>
                                <td width="283" align="left"><?php echo $purchaseOrder[0]['id_PO'];?></td>
                                </tr>
                                <tr>
                                <td align="left">Tanggal Pengiriman : </td>
                                <td align="left"><?php echo $purchaseOrder[0]['tanggal'];?></td>
                                </tr>
                                <tr>
                                <td align="left">Kepada : </td>
                                <td align="left"><p>Direktorat Keuangan</p></td>
                                </tr>
                                <tr>
                                <td></td>
                                <td><p>Pemerintah Provinsi Jawa Barat</p></td>
                                </tr>
                                <tr>
                                <td></td>
                                <td><p>Gedung Sate</p></td>
                                </tr>
                                <tr>
                                <td></td>
                                <td><p>Jalan Diponegoro No. 22, Bandung, Jawa Barat, Indonesia</p>
                                </td>
                                </tr>
                                <tr>
                                <td align="left">Pesanan : </td>
                                <td align="left"><?php echo $tipe[0]['merek'];?>-<?php echo $tipe[0]['jenis'];?>-<?php echo $tipe[0]['model'];?>-<?php echo $katalog[0]['tipe'];?>-<?php echo $katalog[0]['transmisi'];?>-<?php echo $katalog[0]['cc'];?></td>
                                </tr>
                 				<tr>
                                <td align="left">Tahun Anggaran : </td>
                                <td align="left"><?php echo $anggaran[0]['tahun'];?></td>
                                </tr>
                                <tr>
                                <td align="left">Nomor Mata Anggaran : </td>
                                <td align="left"><?php echo $anggaran[0]['nomor_ang'];?></td>
                                </tr>
                                <tr>
                                <td align="left">Nilai Anggaran : </td>
                                <td align="left"><?php echo $anggaran[0]['nilai_ang'];?></td> 
                                </tr>
                                <tr>
                                <td align="left">Daerah Terkait : </td>
                                <td align="left"><?php echo $daerah[0]['daerah'];?></td>
                                </tr>
                                <tr>
                                <td align="left">Alamat Pengiriman : </td>
                                <td align="left"><?php echo $purchaseOrder[0]['alamat'];?></td>
                                </tr>
                                <tr>
                                ...
                                <td align="left"><?php echo $purchaseOrder[0]['OnTR'];?></td>
                                </tr>
                                <tr>
                                <td align="left">Total Harga : </td>
                                <td align="left"><?php echo $purchaseOrder[0]['total_harga'];?></td>
                                </tr>
                                <tr>
                                <td align="left">Tanggal Maksimal Pemenuhan : </td>
                                <td align="left"><?php echo $purchaseOrder[0]['tgl_pemenuhan'];?></td>
                                </tr>
                                <tr>
                                <td align="left">Bank/Nomor Rekening Dealer : </td>
                                <td align="left"><?php echo $dealer[0]['acc_number'];?></td>
                                </tr>
                                <tr>
                                <td></td>
                                <td align="left"><input type="submit" value="Kembali">
