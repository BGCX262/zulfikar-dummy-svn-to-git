                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <form method="get" action="<?=base_url()."index.php/common/ulp_browse1?awal=n"?>" id="form1" name="pencarian">
                                      <h1 align="center">Perencanaan</h1>
                                      ...
                                      <td></td>
                                      <td>
                                      <form method="post" action="<?php echo base_url();?>index.php/common/ulp_hasilcari" name="hasilCari">
