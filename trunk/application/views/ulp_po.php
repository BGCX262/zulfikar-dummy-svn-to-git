                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <h1 align="center">Daftar <em>Purchase Order</em> </h1>
                                    ...
                                    <center>
                                   	...
                                   	<th width="150px">Status PO</th>
                                   	<th width="150px">Tanggal Batas Pemenuhan</th>
                                   	<th width="150px">Dealer</th>
                                   	<th width="150px">Merek</th>
                                   	<th width="150px">Nilai PO</th>
                                   	<th widht="150px"></th>
                                   	</tr>
                					<?php
									...
									if($purchaseOrder[$i]['dealer'] != null){
                					?>
                					<tr>
                					...
                					<td align="center"><?php echo $tipeDariPOIn[$i]['merek1']?></td>
                					<td align="center"><?php echo $purchaseOrder[$i]['total_harga'];?></td>
                					<td align="center"><a href="<?php echo base_url()."index.php/ulp/ulpPO_detail?id_PO=".$purchaseOrder[$i]['id_PO'];""?>">Update Status PO</a>
                					</tr>
                					<?php
                					$no++;
                					}
