                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                              ...
                              <div id="table-content">
                                    <h1 class="style1">Selamat pendaftaran yang anda lakukan telah berhasil, silahkan cek email anda untuk mengaktifkan akun anda</h1>
                                    <span class="style1"><a href="<?php echo base_url()."index.php/common/index"?>">Kembali ke Home</a> </span></div>
                                <!--  end table-content  -->
