                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <h1 align="center"><em>Purchase Request</em> </h1>
                                    ...
                                    <center>
                                   	...
                                   	<th width="150px">Tanggal Maksimal Penawaran</th>
                                   	<th width="150px">Jumlah Penawaran</th>
                                   	<th width="150px">Dealer Pemenang</th>
                                   	<th widht="150px"></th>
                                   	</tr>
                                   	<?php $i=0; while($i<count($purchaseOrder)){?>
                					<tr>
                					<td align="center"><?php echo $purchaseOrder[$i]['id_PO'];?></td>
                					<td align="center"><?php echo $purchaseOrder[$i]['tanggal'];?></td>
                					<td align="center"><?php echo $tipeDariPO[0]['merek'];?></td>
                					<td align="center"><?php echo $tipeDariPO[0]['jenis'];?></td>
                					<td align="center"><?php echo $purchaseOrder[$i]['tgl_PR'];?></td>
                					<td align="center"><?php echo $purchaseOrder[$i]['jumlah_penawaran'];?></td>
                					<td align="center"><?php echo $purchaseOrder[$i]['dealer'];?></td>
                					<?php if($purchaseOrder[$i]['dealer']==""){?>
                					<td align="center"><a href="<?php echo base_url()."index.php/ulp/ulp_penawaran_dealer?id_PO=".$purchaseOrder[$i]['id_PO']."&NMA=".$purchaseOrder[$i]['nomor_ang']."&id_tipe=".$tipeDariPO[0]['id']."&id_katalog=".$katalogDariPO[0]['id'];?>">Lihat Penawaran</a>
                					</tr>
                					<?php }?>
                					<?php $i++;}?>
                                   	</table>
