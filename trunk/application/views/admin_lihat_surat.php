                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <center>
                                <form action="<?php echo base_url();?>index.php/admin/suratPemenuhan" method="post">
                                <table width="571">
                                <tr>
                                <td align="left" colspan="2"><span class="style1">Bersama surat ini, kami : </span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                <td align="left"><span class="style1">No Telp</span></td>
                                <td align="left"><span class="style1">: <?php echo $dealer[0]['of_phone'];?></span></td>
                                </tr>
                                <tr>
                                <td align="left" colspan="2"><p class="style1">&nbsp;</p>
                                  <p class="style1">menyatakan bersedia memenuhi permintaan pengadaan dari : <b><?php echo $purchaseOrder[0]['username'];?></b></p></td>
                         		</tr>
                         		<tr>
                                <tr>
                                	<td><p class="style1">dengan detail pesanan sebagai berikut : </p>
                               	    <p class="style1">&nbsp;</p></td>
                                </tr>
                                  <td align="left"><span class="style1">Tanggal Pemesanan </span></td>
                                ...
                                <td align="left">
                                		...
                                		<tr>
                                		<td class="style2"><div align="center">Warna</div></td>
                                		<td><div align="center"><span class="style2">Stok</span></div></td>
                                		<td><div align="center"><span class="style2">Pesan</span></div></td>
                                		</tr>
                                		<?php $a=0;
                                		while($a<count($warna)){
                               ...
                               <tr>
                            	...
                            	<p align="left" class="style1">Pesanan tersebut akan dipenuhi (diterima oleh pemesan) selambat-lambatnya tanggal :</p></td>
                                 ...
                                 <tr>
                                <td colspan="2" align="center">
                                <p class="style2"><?php echo $purchaseOrder[0]['tgl_pemenuhan']; ?></p>
                                <p class="style2">&nbsp;</p></td>
                                </tr>
                                <tr>
                                <td colspan="2" align="center">
                            	...
                            	<p class="style2"><?php echo $dealer[0]['username']; ?></p>                           		</td>
                                </tr>
                                
                                <tr>
                                <td></td>
                                <td align="center"><input type="submit" value="kembali">                               	  </td>
                                </tr>
                                <tr>
                                <td></td>
                                <td></td>
