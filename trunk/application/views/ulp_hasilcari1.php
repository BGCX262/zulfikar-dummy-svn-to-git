                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
                   ...
                   <table border="1">
                                    ...
                                    for($i=0; $i<count($hasil); $i++){ 
                                    	for($a=0; $a<count($hasil1); $a++){
                                    		if($hasil1[$a]['id_tipe'] == $hasil[$i]['id']){                                   
                                    ?>
                                    <tr>
                                    	<td><?php echo $no;?></td>
                                    	<td><?php echo $hasil[$i]['merek'];?></td>
                                    	<td><?php echo $hasil[$i]['jenis'];?></td>
                                    	<td><?php echo $hasil[$i]['model'];?></td>
                                    	<td><?php echo $hasil1[$a]['tipe'];?></td>
                                    	<td><?php echo $hasil1[$a]['transmisi'];?></td>
                                    	<td><?php echo $hasil1[$a]['cc'];?></td>
                                    	<td><?php echo $hasil1[$a]['OfTR'];?></td>
                                    	<td align="center"><a href="<?=base_url()."index.php/common/ulp_detail1?id_tipe=".$hasil1[$a]['id_tipe']."&id_katalog=".$hasil1[$a]['id']?>">Detail</a></td>
                                    	<td align="center"><a href="<?=base_url()."index.php/ulp/ulp_formulirPR?id_tipe=".$hasil1[$a]['id_tipe']."&id_katalog=".$hasil1[$a]['id']."&NMA=".$NMA?>">Pilih</a></td>
                                    </tr>
                                    <?php 
                                    		}
                                    		$no++;
