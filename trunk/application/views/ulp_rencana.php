                                ...
                                <div id="table-content">
                                    ...
                                    for($i=0; $i<count($hasil); $i++){ 
                                    	for($a=0; $a<count($hasil1); $a++){
                                    		if($hasil[$i]['id'] == $hasil1[$a]['id_tipe']){                                   
                                    ?>
                                    <tr>
                                    	<td><?php echo $no;?></td>
                                    	...
                                    	<td><a href="<?=base_url()."index.php/common/ulp_detail?id_tipe=".$hasil1[$a]['id_tipe']."&id_katalog=".$hasil1[$a]['id']?>">Detail</a></td>
                                    	<td><a href="<?=base_url()."index.php/common/ulp_formulir?id_tipe=".$hasil1[$a]['id_tipe']."&id_katalog=".$hasil1[$a]['id']?>">Pilih</a></td>
                                    </tr>
                                    <?php 
                                    		}
                                    		$no++;
