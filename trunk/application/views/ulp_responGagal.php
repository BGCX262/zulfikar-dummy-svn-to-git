                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <p align="center" class="style2"> </p>
                                      <p>Maaf pembelian Anda melebihi jumlah anggaran</p>
                                      <p>Silahkan ajukan kembali perencanaan atau mengubah besar pembelian</p>
                                      <br>
                                      <center>
                                      <table border="0">
                                       <tr><td><form action="<?php echo base_url()."index.php/ulp/ulp_formulirPO?NMA=".$anggaran[0]['nomor_ang']."&id_tipe=".$tipe_mobil [0] ['id']."&id_katalog=".$katalog_mobil [0] ['id'];?>" method="post">
                                      <input type="submit" value="Kembali"></input>
                                      </form></td>
                                      <td><form action="<?php echo base_url()."index.php/common/ulp_browse";?>" method="post">
                                      <input type="submit" value="Ajukan Rencana"></input></td>	
                                  </form>
                                  </tr>
                                  </table>
                                  </center>
