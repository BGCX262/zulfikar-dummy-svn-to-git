    ...
    <body>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <!--  start page-heading -->
                <div id="page-heading">
                    <h1 align="left">Harga On The Road Tiap Daerah</h1>
                </div>
                <!-- end page-heading -->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <form method="get" action="<?=base_url()."index.php/dealer/inputHarga"?>">

                       			  <div align="center">
                       			    <table width="365" border="0">
                                      <tr>
                                        <td width="233"><span class="style1">Nama ATPM</span></td>
                                        <td width="122"><span class="style1"> : <?php echo $tipe['atpm_name']; ?></span></td>
                                      </tr>
                                      <tr>
                                        <td><span class="style1">Merek Mobil </span></td>
                                        <td><span class="style1">: <?php echo $tipe['merek'];?></span></td>
                                      </tr>
                                      <tr>
                                        <td><span class="style1">Jenis Mobil </span></td>
                                        <td><span class="style1">: <?php echo $tipe['jenis'];?></span></td>
                                      </tr>
                                      <tr>
                                        <td><span class="style1">Model Mobil</span></td>
                                        <td><span class="style1">: <?php echo $tipe['model'];?></span></td>
                                      </tr>
                                      <tr>
                                        <td><span class="style1">Tipe Mobil </span></td>
                                        <td><span class="style1">: <?php echo $katalog['tipe'];?></span></td>
                                      </tr>
                                      <tr>
                                        <td><span class="style1">Transmisi</span></td>
                                        <td><span class="style1">: <?php echo $katalog['transmisi'];?></span></td>
                                      </tr>
                                      <tr>
                                        <td><span class="style1">Isi Silinder (cc)</span></td>
                                        <td><span class="style1">: <?php echo $katalog['cc'];?></span></td>
                                      </tr>
                                      <tr>
                                        <td><span class="style1">Harga Off the Road Jakarta </span></td>
                                        <td><span class="style1">:Rp <?php echo $katalog['OfTR'];?> ,- </span></td>
                                      </tr>
                                                                                </table>
                   			      </div>
       			          ...
       			          <div align="center">
                               			    <table border="0" align="center">
                               			      ...
                               			      <tr>
                               			        <th width="28"><div align="center"><span class="style2">No.</span></div></th>
                                    	    <th width="150"><div align="center"><span class="style2">Kabupaten/Kota</span></div></th>
                                    	    <th colspan="2"><div align="center"><span class="style2">Harga On The Road</span></div></th>
                                    	    </tr>
                               			      <?php
                                  	...
                                  	?>
                                  		    ...
                                  		    <td width="22"><div align="right">Rp </div></td>
                                  		    <td width="178"><div align="center">
                                  		      <input type="text" name="ontr<?=$a?>" value="<?=$harga[$a]['OnTR']?>">
                                  		      </input>
                                		      </div></td>
                                  	    </tr>
                                  	...
                                  	?>
                                  		    ...
                                  		    <td><div align="center">
                                  		      <input type="hidden" name="id_katalog" value="<?=$harga[0]['id_katalog']?>">
