...
<script type="text/javascript">
        	function addInteriorElement(){
            	
				var isiHTML="<tr><td><div align='justify'>Nama</div></td><td><label>"+
					"<div align='justify'>: <input type='tint' name='int[]' /></div></label></td>"+
					"</tr><tr><td><div align='justify'>Keterangan</div></td><td><label>"+
					"<div align='justify'>: <input type='tint' name='int_desc[]' /></div>"+
					"</label></td></tr><tr><td><div align='justify'>Gambar</div></td><td>"+
					"<div align='justify'>: <input type='file' name='int_doc[]' /></div>"+
					"</td></tr>";
				document.getElementById('interior_table').innerHTML+=isiHTML;
        	}

        	function addExteriorElement(){
				var isiHTML="<tr><td><div align='justify'>Nama</div></td><td><label>"+
					"<div align='justify'>: <input type='text' name='ext[]' /></div></label></td>"+
					"</tr><tr><td><div align='justify'>Keterangan</div></td><td><label>"+
					"<div align='justify'>: <input type='text' name='ext_desc[]' /></div>"+
					"</label></td></tr><tr><td><div align='justify'>Gambar</div></td><td>"+
					"<div align='justify'>: <input type='file' name='ext_doc[]' /></div>"+
					"</td></tr>";
				document.getElementById('exterior_table').innerHTML+=isiHTML;
        	}
        </script>
<style type="text/css">
<!--
...
<table border="0" width="100%" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<img src="<?php echo base_url()?>uploads/<?php echo $PIC?>"
			alt="gambarmobil" />
		<form
			action="<?php echo base_url();?>index.php/atpm/submit_katalogstandar/3"
		...
		<table width="359" border="0" id="interior_table">
			<tr>
				<td colspan="2">
				<div align="justify">
				<h2>Interior Mobil</h2>
				</div>
				</td>
			</tr>
			<tr>
				<td>
				<div align="justify">Nama</div>
				</td>
				<td><label>
				<div align="justify">: <input type="text" name="int[]" />
			...
			<tr>
				<td>
				<div align="justify">Keterangan</div>
				</td>
				<td><label>
				<div align="justify">: <input type="text" name="int_desc[]" />
		...
		<br />
		<input type="button" onclick="addInteriorElement()" value="&nbsp;Tambah&nbsp;" />
