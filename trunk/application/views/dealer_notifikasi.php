                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <table border=1>
                                    <tr>
                                    	<td width="82"><div align="center"><strong><span class="style1">Dari</span></strong></div></td>
                                    	<td width="743" align="center"><div align="center"><strong><span class="style1">Notifikasi</span></strong></div></td>
                                    	<td width="154"><div align="center"><strong><span class="style1">Tanggal Hangus</span></strong></div></td>
                                    </tr>
                                    <?php
                                    $now = strtotime(date("Y-m-d"));
                                    $tdp = strtotime($dealer['tdp_date']);
                                    $situ = strtotime($dealer['situ_date']);
									$exp_tdp = $dealer['tdp_date'];
									$exp_situ = $dealer['situ_date'];
									$notif_tdp = strtotime( '-30 day' , strtotime($exp_tdp) ) ;
									$notif_tdp = strtotime(date('Y-m-d' , $notif_tdp ));
									$notif_situ = strtotime( '-30 day' , strtotime($exp_situ) ) ;
									$notif_situ = strtotime(date('Y-m-d' , $notif_situ ));
									
									if($tdp < $now){
										?>
										<tr>
											<td><div align="center"><span class="style1">Sistem</span></div></td>
											<td><span class="style1">Dokumen TDP anda sudah habis masa berlakunya, silahkan lakukan update dokumen</span></td>
											<td><div align="center"><span class="style1">
										    <?=$exp_tdp?>
										    </span></div></td>
										</tr>
										<?php
									}else if ($notif_tdp < $now){
										?>
										<tr>
											<td><div align="center"><span class="style1">Sistem</span></div></td>
											<td><span class="style1">Dokumen TDP anda akan habis masa berlakunya kurang dari 30 hari, silahkan lakukan update dokumen</span></td>
											<td><div align="center"><span class="style1">
										    <?=$exp_tdp?>
										    </span></div></td>
										</tr>
									...
									if($situ < $now){
										...
										<tr>
											<td><div align="center"><span class="style1">Sistem</span></div></td>
											<td><span class="style1">Dokumen SITU anda sudah habis masa berlakunya, silahkan lakukan update dokumen</span></td>
											<td><div align="center"><span class="style1">
										    <?=$exp_situ?>
										    </span></div></td>
										</tr>
										<?php 
									}else if ($notif_situ < $now){
										?>
										<tr>
											<td><div align="center"><span class="style1">Sistem</span></div></td>
											<td><span class="style1">Dokumen SITU anda akan habis masa berlakunya kurang dari 30 hari, silahkan lakukan update dokumen</span></td>
											<td><div align="center"><span class="style1">
										    <?=$exp_tdp?>
										    </span></div></td>
										</tr>
