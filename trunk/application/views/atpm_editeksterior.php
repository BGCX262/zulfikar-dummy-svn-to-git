                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <h1 align="center">Edit Eksterior </h1>
                                    <p align="center" class="style1">Merek : <span class="style2"> <?=$merek['merek']?> </span></p>
                                    <center>
                                    
                                    <form method="POST" action="<?php echo base_url()."index.php/common/editEksterior"?>" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?=$tipe[0]['id']?>">
                                    <input type="hidden" name="eks_prev" value="<?=$eks?>">
                                    <input type="hidden" name="eks_doc_prev" value"<?=$eks_doc?>">
                                    <input type="hidden" name="eks_desc_prev" value="<?$eks_desc?>">
                                    <table>&nbsp;
                                    <tr>
                                    	<th>Gambar:</th> 
                                    	<td><img src="<?php echo base_url();?>uploads/<?=$eks_doc?>" width="150" height="150"><br>
                                    	<input type="file" name="userfile"></td>
                                    </tr>
                                    <tr>
                                    	<th>Nama Interior:</th>
                                    	<td><input type="text" size="25" name="eks" value="<?=$eks?>"></td>
                                    </tr>
                                    <tr>
                                    	<th>Deskripsi:</th>
                                    	<td><input type="text" size="25" name="eks_desc" value="<?=$eks_desc?>"></td>
                                    </tr>
                                    <tr>
                                    	<td></td>
                                    	<td><input type="submit" value="submit" value="upload"></td>
                                    </tr>
                                    </table>
                                    </center>
