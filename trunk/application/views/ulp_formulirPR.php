            ...
            <div id="content">
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
                    <tr>
                        ...
                        <th class="topleft style2"></th>
                        <td id="tbl-border-top"><span class="style2"></span></td>
                        <th class="topright style2"></th>
                        <th rowspan="3" class="sized"><img src="<?php echo base_url();?>images/shared/side_shadowright.jpg" alt="" width="20" height="300" /></th>
                    </tr>
                      <span class="style2">
                      <tr>
                      </span>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <p align="center">
                                    <b>5. Formulir Purchase Request</b><br></br><br></br>
                                    <p align="center">
                                    <center>
                                    <table border="0">
                                    <form action="<?php echo base_url()."index.php/ulp/ulp_pr?NMA=".$NMA."&id_tipe=".$tipe_mobil [0] ['id']."&id_katalog=".$katalog_mobil [0] ['id'];?>" method="post">
                                    <tr>
                                    	<th align="left">
                                   	    <span class="style2">Tanggal</span></th>
                                    	<td width="10px"><span class="style2">:</span></td>
                                    	<td>
                                    	  <span class="style2"><?php echo date("l"), - date("d"); echo - date("m"); echo - date("Y");?></span>                                   	    </td>
                                    	<input type="hidden" name="tanggal" value="<?php echo date("d"); echo - date("m"); echo - date("Y");?>"></input>
                                    </tr>
                                    <tr>
                                    	<th align="left">
                                    	...
                                    	<td width="10px"><span class="style2">:</span></td>
                                    	<td>
                                    	  <span class="style2"><?php echo $username;?></span>                                   	    </td>
                                    </tr>
                                    <tr>
                                    	<th align="left">
                                    ...
                                    <tr height="10"></tr>
                                    <tr>
                                    <th align="left"><span class="style2">Jumlah Pesanan</span></th>
                                    ...
                                    <td align="center" colspan="3"><table border="1">
                                    				<tr><th width="100px" class="style2">Warna</th><th class="style2">Jumlah Pesanan</th></tr>
                                    				<?php $i=0; $jumlah=0;
                                    				while($i<count($warna))
                                    				{?>
                                    				<tr>
                                    				...
                                    				<input type="hidden" name="warna[]" value="<?php echo $warna[$i]['ID'];?>"></input>                                             		</td>
                                    				</tr>
                                    				<?php $i++;
                                    				} ?>
                                    ...
                                    <tr>
                                    	<td align="right" colspan="3"><span class="style2">
                                   	    <input type="submit" name="pilih" value="Kirim Purchase Request" >
                                   	    </input>
                                    	</span></td>
                                    	</form>
                                    </tr>
