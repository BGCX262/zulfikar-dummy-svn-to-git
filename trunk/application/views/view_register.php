...
<script type="text/javascript">
	function validateUsername(){
		panjang=document.formulir.username.value.length;
		if(panjang==0){
	...
	function validatePassword1(){
		panjang=document.formulir.password1.value.length;
		if(panjang==0){
			document.getElementById("labelpassword1").style.visibility="visible";
			return true;
		}else{
			document.getElementById("labelpassword1").style.visibility="hidden";
			return false;
		}
	}

	function validatePassword2(){
		panjang=document.formulir.password2.value.length;
		if(panjang==0){
			document.getElementById("labelpassword2").style.visibility="visible";
			return true;
		}else{
			document.getElementById("labelpassword2").style.visibility="hidden";
			return false;
		}
	}

	function validateEmail(){
		panjang=document.formulir.email.value.length;
		if(panjang==0){
	...
	function validateAll(){
		return (validateEmail() || validatePassword2() || validatePassword1() || validateUsername());
	}
...
<!--  start page-heading -->
<div id="page-heading">
<h1>Pendaftaran Calon Dealer Baru</h1>
</div>
<!-- end page-heading -->
...
<table border="0" width="100%" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<form	action="<?php echo base_url()?>index.php/daftar/proses" method="post" name="formulir" class="style1">
		<table>
			<tr>
				<td><label>
				  <div align="left">Username</div>
				</label></td>
				<td><input type="text" name="username" onblur="return validateUsername();"/></td>
				<td><label class="salahlabel" id="labelusername">
				  <div align="left">Username belum diisi</div>
				</label></td>
			</tr>
			<tr>
				<td><label>
				...
				<td><input type="password" name="password1"  onblur="return validatePassword1();"/></td>
				<td><label class="salahlabel" id="labelpassword1">
				  <div align="left">Password belum diisi</div>
				</label></td>
			</tr>

			<tr>
				<td><label>
				  <div align="left">Konfirmasi Password &nbsp;&nbsp; </div>
				</label></td>
				<td><input type="password" name="password2"  onblur="return validatePassword2();"/></td>
				<td><label class="salahlabel" id="labelpassword2">
				  <div align="left">Password harus sama</div>
				</label></td>
			</tr>
			...
			<tr>
				...
				<td><label class="salahlabel" id="labelemail">
				  <div align="left">Email harus diisi</div>
				</label></td>
			</tr>
		...
		<div align="left" class="style1"><strong><br>
		      </br>
		      <a href="<?php echo base_url()."index.php/common/index"?>">Kembali</a> </strong></div>
		</div>
		<!--  end table-content  -->
