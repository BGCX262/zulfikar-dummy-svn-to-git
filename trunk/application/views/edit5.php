...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" >
            $(document).ready(function() {
                $('#file_upload10').uploadify({
                    'uploader'  : '<?php echo base_url()?>uploadify/uploadify.swf',
                    'script'    : '<?php echo base_url()?>uploadify/uploadify410.php?username=<?php echo $this->session->userdata('username')?>',
            ...
            $(document).ready(function() {
                $('#file_upload11').uploadify({
                    'uploader'  : '<?php echo base_url()?>uploadify/uploadify.swf',
                    'script'    : '<?php echo base_url()?>uploadify/uploadify411.php?username=<?php echo $this->session->userdata('username')?>',
                    'cancelImg' : '<?php echo base_url()?>uploadify/cancel.png',
                    'folder'    : '/amel/uploads',
                    'auto'      : true
                });
            ...
            $(document).ready(function() {
                $('#file_upload12').uploadify({
                    'uploader'  : '<?php echo base_url()?>uploadify/uploadify.swf',
                    'script'    : '<?php echo base_url()?>uploadify/uploadify412.php?username=<?php echo $this->session->userdata('username')?>',
                    'cancelImg' : '<?php echo base_url()?>uploadify/cancel.png',
                    'folder'    : '/amel/uploads',
                    'auto'      : true
                });
            ...
            $(document).ready(function() {
                $('#file_upload13').uploadify({
                    'uploader'  : '<?php echo base_url()?>uploadify/uploadify.swf',
                    'script'    : '<?php echo base_url()?>uploadify/uploadify413.php?username=<?php echo $this->session->userdata('username')?>',
                    'cancelImg' : '<?php echo base_url()?>uploadify/cancel.png',
                    'folder'    : '/amel/uploads',
                    'auto'      : true
                });
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content-regular">
                                    ...
                                    <div id="labelformulir1">Surat Permohonan Menjadi Dealer Rekanan(<a href="<?= base_url()?>files/permohonan_dealer.docx">Unduh Templat</a>)</div><input type="file" name="file_upload" id="file_upload10" />
                                    <div id="labelformulir1">Surat Pernyataan Tidak Pailit (<a href="<?=base_url()?>files/tidak_pailit.docx">Unduh Templat</a>)</div><input type="file" name="file_upload" id="file_upload11" />
                                    <div id="labelformulir1">Surat Pernyataan Kesanggupan Memenuhi Ketentuan E-Purchasing (<a href="<?=base_url()?>files/pernyataan_kesediaan.docx">Unduh Templat</a>)</div><input type="file" name="file_upload" id="file_upload12" />
                                    <div id="labelformulir1">Pakta Integritas (<a href="<?=base_url()?>files/tidak_pailit.docx">Unduh Templat</a>)</div><input type="file" name="file_upload" id="file_upload13" />
                                    <input type="button" class="form-submit" ONCLICK="window.location.href='<?=base_url()?>index.php/dokumenkualifikasi/process/5'" /><a href="<?=base_url()?>index.php/dokumenkualifikasi/edit_submit/4" class="form-kembali" style="font-size: x-large">&nbsp;&nbsp;&nbsp;&nbsp;</a>
